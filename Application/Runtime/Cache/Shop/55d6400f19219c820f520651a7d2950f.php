...
<html>
    ...
    <body>
        <div class="main">
    <form id="register_phone_step2_form" method="post">
        手机号：<p><?php echo ((isset($register_phone) && ($register_phone !== ""))?($register_phone):"没有信息"); ?></p>
        ...
        生日：<input id="register_phone_step2_calendar" name="birthday" type="text"><br />
        验证码：<input type="text" name="verify" class="validate[required]" /><br />
    </form>
    <image id="verify" src="<?php echo U('Shop/Common/getVerify');?>" />
    <button id="register_phone_step2_register">注册</button>
</div>
<!--隐藏值-->
<input type="hidden" id="hidden_value" value={check_url:"<?php echo U('Shop/Login/ajaxRegisterPhoneStep2Check');?>",verify_url:"<?php echo U('Shop/Common/getVerify');?>"} />
